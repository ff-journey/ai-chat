...
export function Thread() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // For text-only content blocks, concatenate them
    ...
    // Allow sending if there's text or image content blocks
    const hasImageBlocks = contentBlocks.some((block: any) => block.type === "image");
    if (!messageContent && !hasImageBlocks) return;
